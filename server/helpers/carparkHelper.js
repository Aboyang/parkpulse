...
export function filterAndSortByDistance(latitude, longitude, radius) {
  return carparkDB
...
export function buildEnrichedEntry(carpark, dist, availabilityData, rating) {
...
export function sortByAvailability(carparks) {
...
export function filterByEV(carparks, evCharging) {
